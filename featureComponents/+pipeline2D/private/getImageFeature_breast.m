function [res, startPos, featureGroupList, featureList] = getImageFeature_breast(lesion, RELOAD_IM_FROM_DICOM, GROUP_FV)
%
% Return Value:
...
bin_l = 0; bin_h = 1024;
F1_THRESH = 512;               % used in feature 1
...
if OLD_HIST_BIN
    ...
    qpv = linspace(bin_l, bin_h, 9);
    bins = linspace(bin_l, bin_h, 9);
    p = hist(d, bins);
else
